...
function showDialog(charStyleNames) {
    ...
    var dlg = new Window("dialog", "CharStyleToHyperlink v" + VERSION);
    ...
    var rbGroup  = scopeRow.add("group");
    rbGroup.orientation  = "column";
    rbGroup.alignChildren = ["left", "center"];
    rbGroup.spacing = 4;

    var rbDoc   = rbGroup.add("radiobutton", undefined, "Entire document");
    var rbFrame = rbGroup.add("radiobutton", undefined, "Current frame story");
    var rbSel   = rbGroup.add("radiobutton", undefined, "Selected text");
    rbDoc.value = true;
